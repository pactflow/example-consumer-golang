...
docker_build:
	docker build -f Dockerfile.$(IMAGE_VARIANT) --build-arg GO_VERSION=${GO_VERSION} -t pactflow/example-consumer-golang-$(IMAGE_VARIANT) .

docker_test: docker_build
	docker run \
		--rm \
		pactflow/example-consumer-golang-$(IMAGE_VARIANT)